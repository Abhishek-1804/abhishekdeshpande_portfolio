const workExperienceData = [
  {
    ...
    responsibilities: [
      "Led a team of 3 to design detailed dashboards containing complex DAX queries and relationships required to expedite exploration of bottlenecks and critical metrics, saving the users hundreds of manhours.",
      "Created and executed complex queries and stored procedures in Microsoft SQL Server.",
  ...
  },
  {
    ...
    responsibilities: [
      "Carried out data conversion, data wrangling, data preparation, and exploratory data analysis (EDA) on an extensive dataset pertaining to fraud analytics.",
